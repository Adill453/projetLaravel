...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">{{ __('Warehouses with Greater Value') }}</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-light py-3">
            <h2 class="h5 mb-0"><i class="fas fa-chart-line me-2"></i>{{ __('Warehouses with Value Greater Than') }} {{ $referenceWarehouse ?? 'Lind-Gislason' }}</h2>
        </div>
